...
exports.logout = exports.login = exports.registrar = exports.verificartoken = void 0;
...
function login(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const con = yield database_1.conectarDb();
        const tareas = yield con
            .request()
            .input("correo", mssql_1.default.VarChar, email)
...
function registrar(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const row = yield con
            .request()
            .input("id_tipo_usuario", mssql_1.default.Int, U.id_tipo_usuario)
            .input("id_tipo_documento", mssql_1.default.Int, U.id_tipo_documento)
            .input("documento", mssql_1.default.VarChar, U.documento)
            .input("correo", mssql_1.default.VarChar, U.correo)
            .input("nombre_persona", mssql_1.default.VarChar, U.nombre_persona)
            .input("apellido_paterno", mssql_1.default.VarChar, U.apellido_paterno)
            .input("apellido_materno", mssql_1.default.VarChar, U.apellido_materno)
            .input("fecha_nacimiento", mssql_1.default.VarChar, U.fecha_nacimiento)
            .input("clave", mssql_1.default.VarChar, U.clave)
            .input("token", mssql_1.default.VarChar, token)
            .execute("USP_RegistrarCandidatoUsuario");
        utils_controller_1.enviarEMailHtml(req.body.correo, "Verificación de Correo", `<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional //EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
function verificartoken(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const conn = yield database_1.conectarDb();
        const rowuser = yield conn
            .request()
            .input("token", mssql_1.default.VarChar, token)
